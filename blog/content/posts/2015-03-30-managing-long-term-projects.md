---
title: Managing Long Term Projects
author: timbeaudet
type: post
date: 2015-03-30T03:07:16+00:00
url: /2015/03/30/managing-long-term-projects/
sfw_pwd:
  - 29GZmpSEoUD2
categories:
  - Programming
...
---
[<img loading="lazy" decoding="async" class="aligncenter wp-image-105" src="http://www.timbeaudet.com/blog/wp-content/uploads/2015/03/project_management_photo.png" alt="project_management_photo" width="720" height="540" srcset="/blog/assets/2015/03/project_management_photo.png 1024w, /blog/assets/2015/03/project_management_photo-300x225.png 300w" sizes="auto, (max-width: 720px) 100vw, 720px" />][1]
...
During my quest of higher quality code, which is never ending, I've set out to create my [personal coding standards][2]. I bought a book on coding standards, read a lot of material on the internets and started that document as a standard for personal and, _if allowed_, professional projects to come. Part of this standard is to use source control on any project with an expected life span of more than two days, **or** has more than a single person. I use SVN, but other systems like Git work just as well.
...
The trick is to never set a project to the side unless it is in a working state. If a project is unbuildable, crashes upon entering the main menu, or in the middle of a refactoring, it is unlikely to be continued once it actually collects dust. By leaving the codebase in a working state, and writing high-quality, **readable and maintainable**, code, you set yourself up for a project that will have a much longer lifetime, but don't take my word for it - try it yourself.
 ...
 [1]: http://www.timbeaudet.com/blog/2015/03/30/managing-long-term-projects/
 [2]: http://www.timbeaudet.com/coding_standards.pdf
