...
And so I've modified my personal [Coding Standards][1] to include; Always use explicit constructors for single argument constructors unless there is an explicit, and good, reason not to.
